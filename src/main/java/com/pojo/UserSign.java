...
public class UserSign implements Serializable{
	...
	public UserSign(Integer uid, String store, String expend, String expend2, String expendqd, String userexpend,
                    Integer status, Integer channel, Integer userstat, Integer type, Date addtime) {
		super();
		this.uid = uid;
		this.store = store;
		this.expend = expend;
